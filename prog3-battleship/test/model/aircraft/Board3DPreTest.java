...
public class Board3DPreTest {
	...
	static String sboard00,sboard01, sboard02, sboardmio1, sboardmio2;
	...
	public void testCheckCoordinateOutOfLimits() {
		assertFalse(board.checkCoordinate(new Coordinate3D(MAX_BOARD_SIZE + 1, MAX_BOARD_SIZE + 1, MAX_BOARD_SIZE + 1)));
	...
	public void testAddCraftOk() {
		...
		try {
			...
			board.addCraft(fighterW, new Coordinate3D(-1, -1, 4));
			board.addCraft(fighter2S, new Coordinate3D(-1, 0, 6));
			board.addCraft(transportN, new Coordinate3D(2, 2, 6));
			board.addCraft(bomberS, new Coordinate3D(1, 3, 3));
	...
	public void testShow1() {
		testAddCraftOk();
		assertEquals(board.show(true), sboard01);
		assertEquals(board.show(false), sboard00);
	}
	...
	public void testAddCraftOutNextTo() {
		...
		try {
			board.addCraft(transportN, new Coordinate3D(6, 3, 6));
		}
	...
	public void testAddCraftColisionNextTo() throws InvalidCoordinateException, NextToAnotherCraftException {
		...
		// 1
		try {
			board.addCraft(bomberE, new Coordinate3D(0, 0, 6));
		}
		...
		assertEquals(board.getCraft(new Coordinate3D(0, 0, 6)), null);
		//System.out.println(board.show(true));	
	...
	public void testGetCraft() throws InvalidCoordinateException, CoordinateAlreadyHitException {
		testAddCraftOk();
		bomberE.setPosition(new Coordinate3D(0,2,1));
		Set<Coordinate> posAbs = bomberE.getAbsolutePositions();
		for(Coordinate c: posAbs) {
			assertEquals(bomberE, board.getCraft(c));
		}
	...
	public void testHit2() throws InvalidCoordinateException, CoordinateAlreadyHitException  {
		...
		assertEquals(board.show(true), sboardmio1);
		
		board.hit(new Coordinate3D(2, 2, 6));
		assertEquals(board.show(true), sboardmio2);
		//System.out.println(board.show(true));
	...
	public void testHitOutOfBoard() {
		...
		try {
			//board.hit(new Coordinate3D(8, 8, 8));
